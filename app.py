...
def main():
    ...
    st.sidebar.markdown(
        '<div style="text-align: center; font-size: 20px; font-weight: bold; color: black; margin-bottom: 15px;">'
    ...
    st.markdown(
        ...
        <div style="display: flex; justify-content: center;">
            <a href="https://www.linkedin.com/company/droguerias-cruz-verde-colombia/?originalSubdomain=co" style="color: #059348; margin: 0 30px;">
                <i class="fab fa-linkedin" style="font-size: 30px;"></i>
            </a>
            <a href="https://www.instagram.com/cruzverdecol/?hl=es-la" style="color: #059348; margin: 0 30px;">
                <i class="fab fa-instagram" style="font-size: 30px;"></i>
            </a>
            <a href="https://www.facebook.com/CruzVerdeCol/?locale=es_LA" style="color: #059348; margin: 0 30px;">
                <i class="fab fa-facebook" style="font-size: 30px;"></i>
            </a>
            <a href="https://x.com/cruzverdeco?lang=es" style="color: #059348; margin: 0 30px;">
...
# -----------------------------------------------------
                ...
                color1 = '#17446E'  # Color del título en formato hexadecimal
                color2 = '#9e9ac8'
                ...
                configuraciones = [
                    {
                        ...
                        'order_f': ['Med de Venta Libre', 'Med Recetados', 'Prod de Higiene', 'Vitaminas y Suplementos', 'Prod para Bebés', 'Prod de Cuidado Femenino', 'Prod de Salud Sexual', 'Prod Dermocosméticos']
                    }]
                ...
                dic1 = ['INSTALACIONES', 'MANTENIMIENTO', 'ESTUDIOS', 'AUMENTOS_CARGA',
                        'FIBRA_OPTICA', 'REDESELECTRICAS', 'ILUMINACION', 'CUENTASNUEVAS']
                dic2 = ['Med de Venta Libre', 'Med Recetados', 'Prod de Higiene', 'Vitaminas y Suplementos',
                        'Prod para Bebés', 'Prod de Cuidado Femenino', 'Prod de Salud Sexual', 'Prod Dermocosméticos']
                    ...
                    configuraciones = [
                        {
                            ...
                            'order_f': ['Med Recetados', 'Med de Venta Libre', 'Prod de Higiene', 'Prod de Cuidado Femenino', 'Prod de Salud Sexual', 'No comprador']
                        }]
                    ...
                    configuraciones = [
                        {
                            ...
                            'order_f': ['Sin catalogar', 'Med Recetados', 'Med de Venta Libre', 'Prod de Cuidado Femenino', 'Prod para Bebés', 'Prod de Salud Sexual']
                    ...
                    configuraciones = [
                        {
                            ...
                            'order_f': ['Sin catalogar', 'Entre 50k y 100k', 'Menor a 30k', 'Entre 100k y 200k',
                                        'Mayor a 500k', 'Entre 30k y 50k', 'Entre 200k y 500k']   # Orden deseado de las categorías
                        }]
